...
const log = logger.getSubLogger({ prefix: ["tournament/[slug]"] });
function TeamPage({
  team,
  isUnpublished,
  markdownStrippedBio,
  ...
  useEffect(() => {
    telemetry.event(
      ...
      collectPageParameters("/tournament/[slug]", { isTeamBooking: true })
    );
  }, [telemetry, pathname]);
      ...
      {eventTypes.map((type, index) => (
        <li
          ...
          <div className="px-6 py-4 ">
            <Link
              href={{
                pathname: `${isValidOrgDomain ? "" : "/tournament"}/${team.slug}/${type.slug}`,
            ...
            <Avatar
              ...
              imageSrc={
                isValidOrgDomain
                  ...
                  : `${WEBAPP_URL}/${team.metadata?.isOrganization ? "org" : "tournament"}/${
                      team.slug
                    }/avatar.png`
              }
              size="lg"
              ...
              (team.isPrivate ? (
                <div className="w-full text-center">
                  <h2 data-testid="you-cannot-see-team-members" className="text-emphasis font-semibold">
                    You cannot see other tournament participants
                  </h2>
                </div>
              ) : (
