...
function NewFormButton() {
  ...
  return (
    <CreateButtonWithTeamsList
      subtitle={"Create a new league".toUpperCase()}
...
export default function Leagues({
  ...
  const leagues = trpc.viewer.appDriveDrop.leagues.useQuery();
  ...
  return (
    <ShellMain
      ...
      subtitle="Create a league to then create tournaments or matches">
...
Leagues.getLayout = (page: React.ReactElement) => {
  return (
...
export const getServerSideProps = async function getServerSideProps(
  ...
  await ssr.viewer.appDriveDrop.leagues.prefetch();
