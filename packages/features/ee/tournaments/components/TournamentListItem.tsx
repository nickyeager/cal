...
//         <span className="text-default text-sm font-bold">{tournament.name}</span>
//         <span className="text-muted block text-xs">
//           {tournament.slug
//             ? orgBranding
//               ? `${orgBranding.fullDomain}/${tournament.slug}`
//               : `${process.env.NEXT_PUBLIC_WEBSITE_URL}/tournament/${team.tournament}`
